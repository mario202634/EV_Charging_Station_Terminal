...
class _ViewBookingsScreenState extends State<ViewBookingsScreen> {
                                  ...
                                  Center(
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        width: 300,
                                        child: ElevatedButton(
                                          onPressed: snapshot.data?.docs[index]['paid'] == false
                                              ? () {
                                            // Perform button action here
                                            updatePrice(snapshot.data!.docs[index].id);
                                            setState(() {
                                              ...
                                              : null,
                                          style: ElevatedButton.styleFrom(
                                            primary: snapshot.data?.docs[index]['paid'] == false
                                                ? Colors.green // Button color when paid is false
                                                : Colors.grey, // Button color when paid is true or null
                                          ),
                                          child: Container(
                                            child: Text(
                                              'Session Paid',
  ...
  void updatePrice(String docId) async {
    try {
      await FirebaseFirestore.instance
          .collection('reservations')
          .doc(docId)
